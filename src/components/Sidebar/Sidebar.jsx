...
export default function Sidebar({ onExpandedChange }) {
  ...
  const recentChats = [
    ...
    { id: 10, title: "Performance optimization techniques", timestamp: "1 month ago" },
    { id: 11, title: "Docker containerization basics", timestamp: "1 month ago" },
    { id: 12, title: "GraphQL vs REST API comparison", timestamp: "1 month ago" }
  ]
